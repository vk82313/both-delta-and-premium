...
# -------------------------------
# HTML Template - DARK MODE (same as before - keeping it short)
# -------------------------------
# [HTML_TEMPLATE string - same as previous - not repeating for brevity]
# In actual deployment, keep the full HTML_TEMPLATE from previous code
